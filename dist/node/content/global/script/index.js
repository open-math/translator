...
const script_4 = require("../../block/mermaid/script");
const script_5 = require("../../inliner/link/script");
const script_6 = require("../../block/task/script");
let products = [
    script_1.init,
    script_2.init,
    script_3.init,
...
globalThis.GenTaskManager = new script_6.GenTaskManager;
