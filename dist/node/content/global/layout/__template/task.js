...
function pug_rethrow(e,n,r,t){if(!(e instanceof Error))throw e;if(!("undefined"==typeof window&&n||t))throw e.message+=" on line "+r,e;var o,a,i,s;try{t=t||require("fs").readFileSync(n,{encoding:"utf8"}),o=3,a=t.split("\n"),i=Math.max(r-o,0),s=Math.min(a.length,r+o)}catch(t){return e.message+=" - could not read from "+n+" ("+t.message+")",void pug_rethrow(e,null,r)}o=a.slice(i,s).map(function(e,n){var t=n+i+1;return(t==r?"  > ":"    ")+t+"| "+e}).join("\n"),e.path=n;try{e.message=(n||"Pug")+":"+r+"\n"+o+"\n\n"+e.message}catch(e){}throw e}function task(locals) {var pug_html = "", pug_mixins = {}, pug_interp;var pug_debug_filename, pug_debug_line;try {;
    ...
    (function (Object, classes, i18n, id, isEditor, similar) {
...
pug_html = pug_html + "\u003Cdiv" + (pug_attr("class", pug_classes(["task",task.script ? 'genTask' : null], [false,true]), false, false)+pug_attr("data-hint-open", isEditor, true, false)+pug_attr("data-solution-open", isEditor, true, false)+pug_attr("data-answer-open", isEditor, true, false)+pug_attr("data-similar-open", isEditor, true, false)+pug_attr("data-note-open", isEditor, true, false)+pug_attr("data-script-id", task.scriptId ? task.scriptId : null, true, false)+pug_attr("data-script", task.script ? task.script : null, true, false)) + "\u003E";
;pug_debug_line = 12;pug_debug_filename = "content\\block\\task\\layout.pug";
...
pug_html = pug_html + "\u003Ch2 class=\"noStyle title\"\u003E";
;pug_debug_line = 17;pug_debug_filename = "content\\block\\task\\layout.pug";
...
;pug_debug_line = 22;pug_debug_filename = "content\\block\\task\\layout.pug";
if ((task.tags)) {
...
pug_html = pug_html + "\u003C\u002Fdiv\u003E";
;pug_debug_line = 27;pug_debug_filename = "content\\block\\task\\layout.pug";
let sectionNames = Object.keys(task.sections);
;pug_debug_line = 29;pug_debug_filename = "content\\block\\task\\layout.pug";
...
;pug_debug_line = 35;pug_debug_filename = "content\\block\\task\\layout.pug";
if ((task.similar)) {
...
;pug_debug_line = 39;pug_debug_filename = "content\\block\\task\\layout.pug";
if ((task.script)) {
...
pug_html = pug_html + "\u003C\u002Fheader\u003E";
;pug_debug_line = 43;pug_debug_filename = "content\\block\\task\\layout.pug";
pug_html = pug_html + "\u003Cdiv class=\"statement\"\u003E";
;pug_debug_line = 43;pug_debug_filename = "content\\block\\task\\layout.pug";
pug_html = pug_html + (null == (pug_interp = task.statement) ? "" : pug_interp) + "\u003C\u002Fdiv\u003E";
;pug_debug_line = 45;pug_debug_filename = "content\\block\\task\\layout.pug";
...
;pug_debug_line = 53;pug_debug_filename = "content\\block\\task\\layout.pug";
pug_html = pug_html + "\u003Cdiv" + (pug_attr("class", pug_classes(["taskHolder",classes], [false,true]), false, false)+pug_attr("id", id, true, false)) + "\u003E";
;pug_debug_line = 54;pug_debug_filename = "content\\block\\task\\layout.pug";
pug_mixins["task"](locals);
;pug_debug_line = 56;pug_debug_filename = "content\\block\\task\\layout.pug";
if ((similar)) {
